...
export default function ClosingSection() {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center text-center px-6 snap-start overflow-hidden">
      ...
      >
        <p className="text-white/70 text-sm font-sans mb-2">Kami yang berbahagia</p>
        <div className="w-10 h-[1px] bg-champagne/40 mx-auto mb-4" />
        <h2 className="font-calligraphy text-4xl sm:text-5xl md:text-6xl text-white text-shadow-glow mb-4">
          Sarah &amp; Ryan
        </h2>
        <div className="w-10 h-[1px] bg-champagne/40 mx-auto mb-6" />
        ...
        <div className="mt-10 flex justify-center">
          <div className="relative">
            {/* REPLACE with your actual couple illustration or keep the abstract SVG */}
